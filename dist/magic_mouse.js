    ...
    if (ua.indexOf('safari') != -1) {
        if (ua.indexOf('chrome') > -1) {
            if (window.screen.width > 768) {
                ...
                var v = () => {
                    r && (r.style.transform = "matrix(1, 0, 0, 1, " + d + ", " + u + ")", r.style.width = o + "px", r.style.height = a + "px"), i && (i.style.transform = "matrix(1, 0, 0, 1, " + l + ", " + m + ") translate3d(-50%, -50%, 0)"), requestAnimationFrame(v)
                };
                ...
                const f = e => {
                        if (h = !0, r) {
                            ...
                            e.classList.contains("magic-hover__square") ? (r.classList.add("cursor-square"), d = t.left, u = t.top, o = t.width, a = t.height) : (d = t.left, u = t.top, o = t.width, a = t.height)
                        }
                        i && i.classList.add("is-hover")
                    },
                    g = () => {
                        h = !1, r && (o = n, a = c, r.style.transition = "transform 0.07s, width 0.3s, height 0.3s, border-radius 0.2s", r.classList.remove("cursor-square"), r.classList.remove("is-hover")), i && i.classList.remove("is-hover")
                    },
                    y = (e, t) => {
                        i && i.classList.add(t)
                    },
            ...
            if (window.screen.width > 768) {
                ...
                const f = e => {
                    ...
                    g = () => {
                        h = !1, r && (o = n, a = c, r.style.transition = "transform 0.07s, width 0.3s, height 0.3s, border-radius 0.2s", r.classList.remove("cursor-square"), r.classList.remove("is-hover")), i && i.classList.remove("is-hover")
                        $("#magicMouseCursor").css("transition", "transform 0s, width 0s, height 0s");
